  ...
  return (
    <nav className="bg-white shadow-custom px-4 sm:px-8 md:px-20 py-4 sm:py-2 flex items-center justify-between relative">
      ...
      <div className="hidden md:flex space-x-4 items-center">
        ...
        <Link to="/commitee" className="hover:text-green-700">
          Committee
        </Link>
        <Link to="/tournaments" className="hover:text-green-700">
          Tournaments
        </Link>
        <Link to="/matches" className="hover:text-green-700">
          Matches
        </Link>
        <Link to="/pointstable" className="hover:text-green-700">
          Points Table
        </Link>
        <Link to="/live" className="hover:text-green-700">
          Live Match
        </Link>
      </div>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 w-56 bg-white shadow-md py-4 z-10 md:hidden flex flex-col items-center space-y-4">
          <Link to="/" onClick={toggleMenu} className="hover:text-green-700">
            Home
          </Link>
          <Link
            to="/tournaments"
